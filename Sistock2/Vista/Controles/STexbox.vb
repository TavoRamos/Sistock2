...
#Region "Globals"
    ...
    Public Property ValidarVacio As Boolean = False
    Enum states
        normal
        focused
        disabled
...
#Region "Initialisation"
    Sub New()
        ...
        Timer.Enabled = True
        Me.Text = OriText
        MyBase.Font = New Font("Dustismo", 12, Drawing.FontStyle.Italic)
        MyBase.ForeColor = Color.FromArgb(237, 237, 237)
...
#Region " Drawing functions "
    ...
    Private Sub DrawBorder(ByVal g As Graphics)
        ...
        Select Case state
            Case states.focused
                BorderPen = New Pen(Color.FromArgb(0, 191, 221))
            Case states.disabled
                BorderPen = New Pen(Color.DarkGray)
            Case states.normal
                BorderPen = New Pen(Color.FromArgb(237, 237, 237))
            Case Else
                Exit Sub
        End Select
...
#Region "Overrides"
    ...
    Protected Overrides Sub OnEnter(ByVal e As System.EventArgs)
        If Me.Text = _Placeholder Then
            Me.Text = ""
            MyBase.Font = New Font("Dustismo", 12, Drawing.FontStyle.Regular)
    ...
    Protected Overrides Sub OnLeave(ByVal e As System.EventArgs)
        If String.IsNullOrWhiteSpace(Me.Text) Or Me.Text = _Placeholder Then
            Me.Text = _Placeholder
            MyBase.Font = New Font("Dustismo", 12, Drawing.FontStyle.Italic)
            MyBase.ForeColor = Color.FromArgb(237, 237, 237)
            If ValidarVacio = True Then
                ERP.SetIconPadding(Me, -20)
                ERP.SetError(Me, "El campo no puede quedar vacio")
            End If
        End If
        'If Me.Text <> _Placeholder Then
        '    Texthaschanged = True
